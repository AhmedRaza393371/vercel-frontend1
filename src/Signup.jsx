            ...
            <div className="w-full bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-700 transition-all duration-300 hover:shadow-2xl">
              ...
              {showConfirmation && (
                <div className="bg-green-500 bg-opacity-20 border border-green-500 text-green-300 px-4 py-3 rounded-lg mb-4">
                  ...
                  <p className="mt-2">Your signup request has been sent to the admin. They will review your request shortly.</p>
                  <button
                    onClick={() => setShowConfirmation(false)}
                    className="mt-3 bg-green-600 text-white px-4 py-1 rounded-lg hover:bg-green-700 transition-all duration-300"
                  >
                    Close
                  </button>
                </div>
